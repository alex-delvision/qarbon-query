    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <Section variant="narrow" padding="lg">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Component Demo</h2>
          <p className="text-gray-600">Showcase of all reusable UI components</p>
        </div>
        ...
        <div className="space-y-16">
          ...
          {/* Live Counters */}
          <div>
            <h3 className="text-xl font-semibold text-gray-900 mb-6">Live Counters</h3>
