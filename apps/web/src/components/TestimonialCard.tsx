  ...
  return (
    <div
      className={`
        ...
        ${variant === 'compact' ? 'testimonial-card-compact' : 
          variant === 'featured' ? 'testimonial-card-featured' : 'testimonial-card-default'}
        ${className}
      `}
      role="article"
    ...
    >
      ...
      <div className="testimonial-content">
        ...
        >
          {showQuotes && variant !== 'featured' && <span className="testimonial-quote-mark" aria-hidden="true">"</span>}
          {quote}
          {showQuotes && variant !== 'featured' && <span className="testimonial-quote-mark" aria-hidden="true">"</span>}
        </blockquote>
      </div>
      ...
      <div className="testimonial-author">
        <div className="testimonial-avatar">
          <Image
            ...
            width={variant === 'compact' ? 40 : variant === 'featured' ? 64 : 48}
            height={variant === 'compact' ? 40 : variant === 'featured' ? 64 : 48}
