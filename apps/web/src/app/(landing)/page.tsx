    ...
    async function fetchNpmDownloads() {
      try {
        const response = await fetch(
          'https://api.npmjs.org/downloads/point/last-month/@qarbon/emissions'
        );
    ...
    <>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center'>
            ...
            <div className='text-center lg:text-left'>
              ...
              <p className='text-xl sm:text-2xl text-white/90 mb-8 leading-relaxed max-w-2xl mx-auto lg:mx-0'>
                Monitor the environmental impact of your AI usage with precise,
                real-time carbon emission tracking. Make informed decisions for
              ...
              <div className='relative w-full max-w-lg lg:max-w-xl xl:max-w-2xl'>
                ...
                >
                  ...
                  >
                    ...
                    {/* Circuit Lines */}
                    <path
                      d='M50 200 L100 200 L120 220 L140 200 L180 200'
                      opacity='0.7'
                    >
                      <animate
                    ...
                    <path
                      d='M350 200 L300 200 L280 180 L260 200 L220 200'
                      opacity='0.7'
                    >
                      <animate
                        attributeName='opacity'
                    ...
                    <path
                      d='M200 50 L200 100 L220 120 L200 140 L200 180'
                      opacity='0.7'
                    >
                      <animate
                        attributeName='opacity'
                    ...
                    <path
                      d='M200 350 L200 300 L180 280 L200 260 L200 220'
                      opacity='0.7'
                    >
                      <animate
                        attributeName='opacity'
      ...
      <Section variant='wide' className='bg-white'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Track, measure, and offset your AI carbon footprint with
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
          ...
          <div className='group bg-white rounded-xl p-8 border border-gray-200 hover:shadow-lg hover:shadow-green-100 transition-all duration-300 hover:border-green-200'>
            ...
            <p className='text-gray-600 leading-relaxed'>
              Seamlessly monitor AI usage across OpenAI, Anthropic, Google,
              Meta, and Microsoft platforms with zero configuration required.
            </p>
          </div>
          ...
          <div className='group bg-white rounded-xl p-8 border border-gray-200 hover:shadow-lg hover:shadow-green-100 transition-all duration-300 hover:border-green-200'>
            ...
            <p className='text-gray-600 leading-relaxed'>
              Get precise carbon emission calculations in sub-millisecond
              timing, providing instant feedback on your AI environmental
              impact.
            </p>
          </div>
          ...
          <div className='group bg-white rounded-xl p-8 border border-gray-200 hover:shadow-lg hover:shadow-green-100 transition-all duration-300 hover:border-green-200'>
            ...
            <p className='text-gray-600 leading-relaxed'>
              Instantly offset your carbon footprint through integrated
              partnerships with verified carbon credit providers worldwide.
            </p>
          </div>
        </div>
      </Section>
      ...
      >
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Join thousands of developers and organizations using Qarbon Query to
            track and offset their AI carbon footprint
          </p>
        </div>
          ...
          <div className='flex justify-center'>
            <div className='bg-white rounded-xl p-12 shadow-lg border border-gray-100 text-center max-w-md'>
              ...
              <p className='text-gray-500'>
                User testimonials will be featured here once we launch publicly.
              </p>
            </div>
          </div>
        </div>
