 ...
 */
import { UniversalTrackerRegistry, EmissionAdapter, FormatDetectionResult } from './UniversalTrackerRegistry.js';
...
export declare class OptimizedUniversalTrackerRegistry extends UniversalTrackerRegistry {
    ...
    constructor(initial?: Record<string, EmissionAdapter>, optimizationConfig?: Partial<OptimizationConfig>);
    /**
     * Enhanced format detection with optimizations
     */
    detectFormatOptimized(input: Buffer | NodeJS.ReadableStream): Promise<OptimizedDetectionResult>;
    /**
     ...
     */
    benchmarkDetection(data: Buffer, iterations?: number): Promise<{
